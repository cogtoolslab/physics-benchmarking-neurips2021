...
function initializeWithTrials(socket) {
  var gameid = UUID();
  var colname = 'human-physics-benchmarking-clothiness-pilot_production_2'; //insert STIMULI DATASETNAME here
  sendPostRequest('http://localhost:8020/db/getstims', {
    json: {
      dbname: 'stimuli',
      colname: colname,
      //numTrials: 1,
