...
function initializeWithTrials(socket) {
  var gameid = UUID();
  var colname = 'human-physics-benchmarking-collision-pilot_production_1'; //insert STIMULI DATASETNAME here
  sendPostRequest('http://localhost:8073/db/getstims', {
    json: {
      dbname: 'stimuli',
      colname: colname,
      //numTrials: 1,
