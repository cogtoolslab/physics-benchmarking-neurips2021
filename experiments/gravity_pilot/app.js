...
function initializeWithTrials(socket) {
  var gameid = UUID();
  var colname = 'human-physics-benchmarking-gravity-pilot_example'; //insert STIMULI DATASETNAME here
  sendPostRequest('http://localhost:8018/db/getstims', {
    json: {
      dbname: 'stimuli',
      colname: colname,
      //numTrials: 1,
