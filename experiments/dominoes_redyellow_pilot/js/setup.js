...
var noverlay_url = 'https://human-physics-benchmarking-dominoes-redyellow-pilot.s3.eu-central-1.amazonaws.com/noverlay.png'
...
var colname = 'dominoes_redyellow_pilot'; //insert COLLECTION NAME
  ...
  socket.on('onConnected', function (d) {
    ...
    var familiarization_trials_pre =  _.map(familiarization_stims, function(n,i) {
      return _.extend({}, familiarizationExperimentInstance, n, {
        trialNum: i,
        stimulus: [n.stim_url],
        overlay: [noverlay_url],  // overwriting the map url with a transparent image
        overlay_time: 2.,
        blink_time: 500,
    ...
    var instructionsHTML = {
      ...
      a certain event will happen after the video ends.</p><p>You\'ll be asked if the red object will touch the yellow area.\
      </p><p>You will do a few “warmup” trials first, followed by 150 real trials. For the warmup trials, you will find out whether your response was correct or not, but you won\'t on the real trials.']
    };
