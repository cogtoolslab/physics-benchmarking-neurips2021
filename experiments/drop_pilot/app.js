...
function initializeWithTrials(socket) {
  var gameid = UUID();
  var colname = 'human-physics-benchmarking-drop-pilot_production_1'; //insert STIMULI DATASETNAME here
  sendPostRequest('http://localhost:8074/db/getstims', {
    json: {
      dbname: 'stimuli',
      colname: colname,
      //numTrials: 1,
